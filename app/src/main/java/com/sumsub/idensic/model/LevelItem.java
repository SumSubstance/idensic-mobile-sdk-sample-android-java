...
public final class LevelItem {
    ...
    public LevelItem(@Nullable String id, @Nullable String key, @Nullable String clientId, @Nullable String name, @Nullable String reviewReasonCode, @Nullable String createdAt, @Nullable String createdBy, @Nullable String modifiedAt, @Nullable String msdkFlowId, @Nullable String type) {
        this.id = id;
        this.key = key;
